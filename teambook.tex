\documentclass[8pt,a4paper,landscape,twosided]{extarticle}
...
\subsection{Z, префикс, Манакер, min rotation}
\begin{lstlisting}[language=C++]
