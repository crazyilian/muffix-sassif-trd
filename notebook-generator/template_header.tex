...
\geometry{verbose,landscape,${paper},tmargin=1.1cm,bmargin=0.7cm,lmargin=0.6cm,rmargin=0.6cm}
...
\lstset{frame=tb,
    ...
    columns=flexible,
    keepspaces=true,
    basicstyle={\fontsize{${fontSize}}{${fontSize}}\ttfamily},
    numbers=none,
...
\fancyhead[L]{\fontsize{8}{8}\selectfont\bf{${initials}}}
